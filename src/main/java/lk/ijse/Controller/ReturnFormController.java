...
NameLabel.setText(name);
    ...
    private void updateReturn() throws SQLException, ClassNotFoundException {
     ...
     String date="2024-03-18";
        ...
        int Qty = Integer.parseInt(ReturnBookCount.getText());
        ...
        if (book != null && user != null) {
            ...
            ReturnDto returnDto = new ReturnDto(Id, user.getName(), book.getID(), date, Qty);

            try {
                // Add the Borrow object to the database
                returnBo.addReturn(returnDto);
